...
const BurgerMenu = ({ open }: { open: any }) => {
    return (
            ...
            <div className="pointer z-100 will-change-opacity fixed absolute left-0 top-16 ml-0 flex h-screen w-screen flex-col items-start overflow-scroll bg-white bg-opacity-90 px-6 pt-20 backdrop-blur-3xl" data-projection-id={12} style={{ opacity: 1 }}>
                <ul className="font-900 w-full text-xl uppercase">
                    <li className=" border-b border-black border-opacity-10">
                        <a className="relative block flex w-full items-center py-3 text-black" href="/">
                            HOME{" "}
                        </a>
                    </li>
                    <li className=" border-b border-black border-opacity-10">
                        <a className="relative block flex w-full items-center py-3 text-black" href="/about">
                            ABOUT{" "}
                        </a>
                    </li>
                    <li className=" border-b border-black border-opacity-10">
                        <a className="relative block flex w-full items-center py-3 text-black" href="/mint">
                            BUY{" "}
                        </a>
                    </li>
                    <li className=" border-b border-black border-opacity-10">
                        <a className="relative block flex w-full items-center py-3 text-black" href="/team">
                            ROADMAP{" "}
                        </a>
                    </li>
                    <li className=" border-b border-black border-opacity-10">
                    ...
                    <li className=" border-b border-black border-opacity-10">
                        <a className="relative block flex w-full items-center py-3 text-black" href="/marketplace">
                            GALLERY{" "}
                        </a>
                    </li>

                    <li className=" border-b border-black border-opacity-10">
                        <a href="https://twitter.com/lokaversenft" target="_blank" className="relative block flex w-full items-center py-3 text-black" rel="noreferrer">
                            twitter{" "}
                    ...
                    <li className=" border-b border-black border-opacity-10">
                        <a href="https://www.instagram.com/lokaversenft/" target="_blank" className="relative block flex w-full items-center py-3 text-black" rel="noreferrer">
                            instagram{" "}
                            <svg xmlns="http://www.w3.org/2000/svg" className="ml-auto h-4 w-4 fill-current stroke-current" viewBox="0 0 40 40">
                    ...
                    <li className=" border-b border-black border-opacity-10">
                        <a href="http://discord.gg/" target="_blank" className="relative block flex w-full items-center py-3 text-black" rel="noreferrer">
                            discord{" "}
                            <svg xmlns="http://www.w3.org/2000/svg" className="ml-auto h-4 w-4 fill-current stroke-current" viewBox="0 0 40 40">
                ...
                <p className="text-2xs mt-6 pb-4 text-left font-mono uppercase opacity-80">Loka Labs © 2022</p>
            </div>
        </>
    );
};
