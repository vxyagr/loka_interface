...
const HomePage: FunctionComponent<HomePageProps> = ({}) => {
    ...
    return (
        <div className={`${bgCol}  w-full overflow-clip  font-inter`} style={{ background: "radial-gradient(105.51% 158.08% at 50% -14.6%, #28556C 0%, rgba(10, 47, 12, 0.95) 41.22%, #0A2F0C 67.68%)" }}>
            <Head>
                {/* <!-- HTML Meta Tags --> */}
